                    ...
                    <table class="table table-bordered">
                        <thead>
                          ...
                          <tr>
                            ...
                            <c:if test="${genero.isEstado()==true}">
                                <td>
                                    <span>Genero Activo</span>
                                </td> 
                            </c:if>
                            <c:if test="${genero.isEstado()==false}">
                                <td>
                        ...
                        <c:if test="${genero.isEstado()==true}">
                            <td>
                            <a href="genero?accion=est&id=${genero.getId()}&estado=false">
                        ...
                        <c:if test="${genero.isEstado()==false}">
                            <td>
                            <a href="genero?accion=est&id=${genero.getId()}&estado=true">
                                <button type="button"  style="margin: 0em auto 2em;  background-color: rgb(85, 85, 85);" class="btn btn-light">
